...
public class MomPlaylistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int n = 20;
        for (int i = 1; i <= n; i++) {
            songs.add(new Song("Mom's Favorite Artist Name " + i, "SongTitle" + i, "Duration" + i));
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent nowPlayingIntent = new Intent(MomPlaylistActivity.this, NowPlayingActivity.class);
