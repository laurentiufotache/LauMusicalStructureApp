...
public class GirlPlaylistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int n = 8;
        for (int i = 1; i <= n; i++) {
            songs.add(new Song("Girl's Favorite Artist Name " + i, "SongTitle" + i, "Duration" + i));
        }
        ...
        listView.setBackgroundColor(Color.parseColor("#7C4DFF"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent nowPlayingIntent = new Intent(GirlPlaylistActivity.this, NowPlayingActivity.class);
